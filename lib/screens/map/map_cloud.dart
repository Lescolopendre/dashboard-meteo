...
class FranceMapWithCloud extends StatelessWidget {
  @override
    ...
    return Scaffold(
      body: Container(
        decoration: BoxDecoration(
          ...
          // Ajouter une couleur de fond si nécessaire
          color: Colors.white,
        ),
        child: ClipRRect(
          borderRadius: BorderRadius.circular(20.0),
          child: FlutterMap(
            ...
            children: [
              ...
              TileLayer(
                urlTemplate:
                'https://tile.openweathermap.org/map/clouds_new/{z}/{x}/{y}.png?appid=c00feaeec48cc819f3c1464a14387b79',
                subdomains: ['a', 'b', 'c'], // Sous-domaines pour améliorer la performance
