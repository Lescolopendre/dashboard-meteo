...
class FranceMapWithPrecipitation extends StatelessWidget {
  @override
    ...
    return Scaffold(
      body: FlutterMap(
        ...
        children: [
          ...
          TileLayer(
            urlTemplate:
            'https://tile.openweathermap.org/map/precipitation_new/{z}/{x}/{y}.png?appid=c00feaeec48cc819f3c1464a14387b79',
            subdomains: ['a', 'b', 'c'], // Sous-domaines pour améliorer la performance
